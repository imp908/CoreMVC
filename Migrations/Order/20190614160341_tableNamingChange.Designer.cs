...
namespace mvccoresb.Migrations.Order
{
    ...
    partial class tableNamingChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("order.Domain.Models.AddressDAL", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("order.Domain.Models.DeliveryItemDAL", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("order.Domain.Models.DeliveryItemDimensionUnitDAL", b =>
                {
                    ...
                    b.ToTable("DeliveryItemDimensionUnit");
            ...
            modelBuilder.Entity("order.Domain.Models.DimensionalUnitDAL", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("order.Domain.Models.OrderItemDAL", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("order.Domain.Models.OrdersAddressesDAL", b =>
                {
            ...
            modelBuilder.Entity("order.Domain.Models.OrdersDeliveryItemsDAL", b =>
                {
                    b.Property<Guid>("OrderId");
                    ...
                    b.ToTable("OrdersDeliveryItems");
                });

            modelBuilder.Entity("order.Domain.Models.UnitsConvertionDAL", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("order.Domain.Models.DeliveryItemDimensionUnitDAL", b =>
                {
                    b.HasOne("order.Domain.Models.DeliveryItemDAL", "DelivertyItem")
                        .WithMany("Parameters")
                        .HasForeignKey("DeliveryItemId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("order.Domain.Models.DimensionalUnitDAL", "Unit")
            ...
            modelBuilder.Entity("order.Domain.Models.OrdersAddressesDAL", b =>
                {
                    b.HasOne("order.Domain.Models.AddressDAL", "AddressFrom")
                        .WithMany("Orders")
                        .HasForeignKey("AddressFromId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("order.Domain.Models.AddressDAL", "AddressTo")
                        .WithMany()
                        .HasForeignKey("AddressToId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("order.Domain.Models.OrderItemDAL", "Order")
                        .WithMany("Directions")
            ...
            modelBuilder.Entity("order.Domain.Models.OrdersDeliveryItemsDAL", b =>
                {
                    b.HasOne("order.Domain.Models.DeliveryItemDAL", "Delivery")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("order.Domain.Models.UnitsConvertionDAL", b =>
                {
                    b.HasOne("order.Domain.Models.DimensionalUnitDAL", "From")
                        .WithMany()
                        .HasForeignKey("FromId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("order.Domain.Models.DimensionalUnitDAL", "To")
