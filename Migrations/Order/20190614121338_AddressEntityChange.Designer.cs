...
namespace mvccoresb.Migrations.Order
{
    ...
    [Migration("20190614121338_AddressEntityChange")]
    partial class AddressEntityChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("order.Domain.Models.Ordering.AddressDAL", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("order.Domain.Models.Ordering.OrdersAddressesDAL", b =>
                {
            ...
            modelBuilder.Entity("order.Domain.Models.Ordering.OrdersAddressesDAL", b =>
                {
                    b.HasOne("order.Domain.Models.Ordering.AddressDAL", "AddressFrom")
                        .WithMany("Orders")
                        .HasForeignKey("AddressFromId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("order.Domain.Models.Ordering.AddressDAL", "AddressTo")
                        .WithMany()
